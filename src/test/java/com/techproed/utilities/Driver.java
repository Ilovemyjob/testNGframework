...
public class Driver {
    ...
    public static WebDriver getDriver(){//like TestBase class setUP()
        ...
        if(driver==null) {//to use driver again and again
            switch (ConfigReader.getProperty("browser")) {
                ...
                case "ie":
                    ...
                    break;
                case "chrome-headless"://sayfa acmadan calismasi icin
                    WebDriverManager.chromedriver().setup();
...
//singlatin driver for entire Framework